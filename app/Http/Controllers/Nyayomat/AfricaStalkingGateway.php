...
class AfricaStalkingGateway
{
    ...
    // Payments
    public function bankPaymentCheckoutCharge(
        $productName_,
        $bankAccount_,
        $currencyCode_,
        $amount_,
        ...
        if ($this->_responseInfo['http_code'] == self::HTTP_CODE_CREATED) {
            ...
            if ($response->status == "PendingValidation") {
    ...
    public function bankPaymentCheckoutValidation(
        $transactionId_,
        $otp_
    ) {
        $this->_requestBody = json_encode(array("username"      => $this->_username,
    ...
    public function bankPaymentTransfer(
        $productName_,
        $recipients_
    ) {
        $this->_requestBody = json_encode(array("username"    => $this->_username,
    ...
    public function cardPaymentCheckoutCharge(
        $productName_,
        $paymentCard_,
        $currencyCode_,
        $amount_,
    ...
    public function cardPaymentCheckoutChargeWithToken(
        $productName_,
        $checkoutToken_,
        $currencyCode_,
        $amount_,
    ...
    public function cardPaymentCheckoutValidation(
        $transactionId_,
        $otp_
    ) {
        $this->_requestBody = json_encode(array("username"      => $this->_username,
