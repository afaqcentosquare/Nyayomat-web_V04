...
class AssetProviderController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('acp.superadmin.assetprovider.index')
    ...
    public function updateStatus($id,$status)
    {
        try{
            ...
            if($status == "decline"){
                ...
                Mail::send('acp.mail.decline', $data, function($message) use ($asset_provider_detail) {
                ...
                Mail::send('acp.mail.approve', $data, function($message) use ($asset_provider_detail) {
                ...
                $data = array('name'=>$asset_provider_detail->shop_name);
                Mail::send('acp.mail.shortlist', $data, function($message) use ($asset_provider_detail) {
                ...
                Mail::send('acp.mail.suspend', $data, function($message) use ($asset_provider_detail) {
