...
namespace App\Http\Controllers\ACP\AssetProvider;
...
class AuthController extends Controller
{
    ...
    {
        return view('acp.assetprovider.auth.register');
    }
    ...
    public function loginView()
    {
        ...
        return view('ecommerce_frontend.assetprovider.login');
    }
    ...
    public function registerRequest(Request $request)
    {
        ...
        try{
            ...
            if($asset_provider->save()){
                return back()->withSuccess("Your request has been successfully received. One of our team members will get in touch with you shortly on next steps.")->withInput();
            }else{
                return back()->withError("Something went wrong with your request :(")->withInput();
            }
    ...
    public function setPasswordView($id)
    {
        ...
        if($asset_provider->password == null){
            ...
            return view('acp.frontend.assetprovider.set_password')->with("asset_provider", $asset_provider);
        }else{
