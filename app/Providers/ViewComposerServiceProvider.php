...
class ViewComposerServiceProvider extends ServiceProvider
{
    ...
    {
        View::share('cities', ListHelper::cities());
        ...
        $this->composeMerchantTransactionsList();

        // $this->composeMerchantProductList();

        // $this->composeMerchantransTactionsList();
    }

    /**
     * compose partial view of merchant transaction .
     */
    private function composeMerchantTransactionsList()
    {
        // View::composer(
        //     'pages.backend.merchant.transactions',

        //         function ($view) {
        //             $view->with('transactions', Order::where('shop_id',Auth::user()->merchantId())->get());
        //         });
    }
    ...
    {
        View::composer(
                'pages.backend.merchant.dashboard',
            ...
            $period = $start->diffInDays($end);
                    ...
                    $view->with([
                        ...
                        'bottom_listings' => ListHelper::bottom_listing_items(),
                        ...
                        'sales_total' => Statistics::sales_total(),
    ...
    private function composeBannerForm()
    {
        View::composer(
            ...
            function ($view) {
                ...
                ->with('locations', ListHelper::countries());
            }
        );
    }
