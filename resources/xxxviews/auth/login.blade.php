    ...
    <div class="box login-box-body">
        ...
        <div class="box-body">
            {!! Form::open(['route' => 'login', 'id' => 'form']) !!}
                ...
                <div class="form-group has-feedback">
                    {!! Form::password('password', ['class' => 'form-control input-lg', 'id' => 'password', 'placeholder' => trans('app.placeholder.password') . ' should be 6 characters', 'data-minlength' => '6', 'required']) !!}
                ...
                <div class="row">
                    ...
                    <div class="col-xs-5">
                        {!! Form::submit(trans('app.form.login'), ['class' => 'btn btn-block btn-lg btn-flat btn-success']) !!}
                    </div>
                </div>
            {!! Form::close() !!}
        </div>
