		...
		<div class="box-header with-border">
			...
			<div class="box-tools pull-right">
				@can('create', App\ShippingZone::class)
					<a href="#" data-link="{{ route('admin.shipping.shippingZone.create') }}" class="ajax-modal-btn btn btn-success btn-flat">{{ trans('app.add_shipping_zone') }}</a>
				@endcan
			</div>
		</div> <!-- /.box-header -->
		<div class="box-body">
						...
						<div class="pull-right">
							...
							@endcan
						  	...
						  	@unless($shipping_zone->rest_of_the_world)
								@can('create', App\ShippingZone::class)
									<a href="#" data-link="{{ route('admin.shipping.shippingZone.edit', $shipping_zone->id) }}"  class="ajax-modal-btn btn btn-success btn-flat">
							...
							@can('update', $shipping_zone)
								<a href="#" data-link="{{ route('admin.shipping.shippingZone.edit', $shipping_zone->id) }}"  class="ajax-modal-btn btn btn-success btn-flat"><i class="fa fa-edit"></i> {{ trans('app.edit') }}</a>
							@endcan
