	...
	<div class="box">
	    <div class="box-header with-border">
	      ...
	      <div class="box-tools pull-right">
				<a href="#" data-link="{{ route('admin.setting.announcement.create') }}" class="ajax-modal-btn btn btn-success btn-flat">{{ trans('app.add_announcement') }}</a>
	      </div>
	    </div> <!-- /.box-header -->
	    <div class="box-body">
	        ...
	        <tbody>
		        @foreach($announcements as $announcement )
			        <tr>
			          ...
			          <td>
			          	<a href="{{ $announcement->action_url }}" class="btn btn-success btn-xs btn-flat" target="_blank">
			          ...
			          <td class="row-options text-muted small">
		                    <a href="#" data-link="{{ route('admin.setting.announcement.edit', $announcement->id) }}"  class="ajax-modal-btn"><i data-toggle="tooltip" data-placement="top" title="{{ trans('app.edit') }}" class="fa fa-edit"></i></a>&nbsp;
