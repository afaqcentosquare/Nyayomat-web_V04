					    	...
					    	<div class="col-sm-6">
					  		...
					  		@if($can_update)
								<div class="col-sm-12">
						            ...
						            {!! Form::submit(trans('app.update'), ['class' => 'btn btn-lg btn-flat btn-success col-sm-offset-2']) !!}
						        </div>
					  		@endif
				        {!! Form::close() !!}
			    	</div>
									...
									<ul class="list-group">
										<li class="list-group-item">
											...
											@if($payment_provider->admin_help_doc_link)
												<a href="{{ $payment_provider->admin_help_doc_link }}" class="btn btn-success" target="_blank"> {{ trans('app.documentation') }}</a>
												<span class="spacer15"></span>
											@endif
										</li>
						    		</ul>
