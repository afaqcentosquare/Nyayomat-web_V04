	...
	<div class="box">
	    <div class="box-header with-border">
	      ...
	      <div class="box-tools pull-right">
			@can('index', $ticket)
				<a href="{{ route('admin.support.ticket.index') }}" class="btn btn-success btn-flat">{{ trans('app.back') }}</a>
			@endcan
			@can('reply', $ticket)
				<a href="#" data-link="{{ route('admin.support.ticket.reply', $ticket) }}" class="ajax-modal-btn btn btn-success btn-flat">{{ trans('app.reply') }}</a>
			@endcan
	      </div>
	    </div> <!-- /.box-header -->
	    <div class="box-body">
			<div class="row">
			  	...
			  	<div class="col-md-3">
					<div class="form-group">
						...
						@can('assign', $ticket)
							<a class="btn btn-success ajax-modal-btn" href="#" data-link="{{ route('admin.support.ticket.showAssignForm', $ticket) }}"><i class="fa fa-hashtag"></i> {{ trans('app.assign') }}</a>
						@endcan
				  	</div>
