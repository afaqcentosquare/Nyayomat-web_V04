		...
		<div class="box-header with-border">
			...
			<div class="box-tools pull-right">
				@can('create', App\SubscriptionPlan::class)
					<a href="#" data-link="{{ route('admin.setting.subscriptionPlan.create') }}" class="ajax-modal-btn btn btn-success btn-flat">{{ trans('app.add_subscription_plan') }}</a>
				@endcan
			</div>
		</div> <!-- /.box-header -->
		<div class="box-body">
			<table class="table table-hover table-no-option" id="sortable" data-action="{{ Route('admin.setting.subscriptionPlan.reorder') }}">
				<thead>
					<tr>
						...
						<th><i class="fa fa-money"></i> Cost/Day</th>
				...
				<tbody>
					@foreach($subscription_plans as $subscriptionPlan )
						<tr id="{{ $subscriptionPlan->plan_id }}">
							...
							<td>{{ round($subscriptionPlan->cost) }} KSh</td>
