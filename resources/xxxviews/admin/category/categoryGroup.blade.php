	    ...
	    <div class="box-header with-border">
	      ...
	      <div class="box-tools pull-right">
			@can('create', App\CategoryGroup::class)
				<a href="#" data-link="{{ route('admin.catalog.categoryGroup.create') }}" class="ajax-modal-btn btn btn-success btn-flat">{{ trans('app.add_category_group') }}</a>
			@endcan
	      </div>
	    </div>
	    <!-- /.box-header -->
