        ...
        <div class="info-box">
          ...
          <div class="info-box-content">
            <span class="info-box-text">{{ trans('app.avg_order_value') }}</span>
                <span class="info-box-number">
                  @if($orders_count)
                    {{ round($sales_total/$orders_count) }} KSh
                  @else
                    0
                  @endif
                </span>
  ...
  <div class="row">
    <div class="col-sm-8 nopadding-right">
      <div class="box box-solid">
        ...
        <div class="box-body">
            <p class="text-muted"><span class="lead"> {{ trans('app.total') }}: {{ round($sales_total) }} KSh </span><span class="pull-right">{{ $orders_count . ' ' . trans('app.orders') }}</span></p>
            ...
            <table class="table table-default">
              <tbody>
                <tr>
                  ...
                  <td class="pull-right">{{ round($sales_total) }} KSh</td>
                </tr>
                <tr>
                  <td>{{ trans('app.discounts') }}</td>
                  <td class="pull-right">-{{ round($discount_total, config('system_settings.decimals')) }} KSh</td>
                </tr>
                <tr>
                  <td>{{ trans('app.refunds') }}</td>
                  <td class="pull-right">-{{ round($latest_refund_total, config('system_settings.decimals')) }} KSh</td>
                </tr>
                <tr>
                  <td>{{ trans('app.net_sales') }}</td>
                  <td class="pull-right"><span class="lead">{{ round($sales_total - ($discount_total + $latest_refund_total)) }} KSh</span></td>
                </tr>
              </tbody>
            </table>
              ...
              <tbody>
                @foreach($top_listings as $inventory)
                  <tr>
                    ...
                    <td class="text-center">{{ round($inventory->gross_sales) }} KSh</td>
                    <td>&nbsp;</td>
                  </tr>
                @endforeach
              </tbody>
                  ...
                  <tbody>
                    @forelse($top_customers as $customer)
                      <tr>
                        ...
                        <td class="text-center">{{ round(round($customer->orders->sum('total'))) }} KSh</td>
                      </tr>
                    @empty
                      <tr>
