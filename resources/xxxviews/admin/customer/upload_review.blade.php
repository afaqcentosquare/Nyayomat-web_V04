...
@section('content')
	<div class="box">
		<div class="box-header with-border">
			...
			<div class="box-tools pull-right">
				@can('create', App\Customer::class)
					<a href="#" data-link="{{ route('admin.admin.customer.bulk') }}" class="ajax-modal-btn btn btn-success btn-flat">{{ trans('app.bulk_import') }}</a>
				@endcan
			</div>
		</div> <!-- /.box-header -->
		...
		<div class="box-footer">
			<a href="{{ route('admin.admin.customer.index') }}" class="btn btn-success btn-flat">{{ trans('app.cancel') }}</a>
			<div class="box-tools pull-right">
				{!! Form::open(['route' => 'admin.admin.customer.import', 'id' => 'form', 'class' => 'inline-form', 'data-toggle' => 'validator']) !!}
		        	...
		        	@endforeach
					{!! Form::button(trans('app.looks_good'), ['type' => 'submit', 'class' => 'confirm btn btn-success btn-flat']) !!}
				{!! Form::close() !!}
			</div>
		</div> <!-- /.box-footer -->
	</div> <!-- /.box -->
