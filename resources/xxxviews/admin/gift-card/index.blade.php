		...
		<div class="box-header with-border">
			...
			<div class="box-tools pull-right">
				@can('create', App\GiftCard::class)
					{{-- <a href="#" data-link="{{ route('admin.exim', 'gift-card') }}" class="ajax-modal-btn btn btn-success btn-flat">{{ trans('app.bulk_import') }}</a> --}}
					<a href="#" data-link="{{ route('admin.promotion.giftCard.create') }}" class="ajax-modal-btn btn btn-success btn-flat">{{ trans('app.add_gift_card') }}</a>
				@endcan
			</div>
		</div> <!-- /.box-header -->
		<div class="box-body">
