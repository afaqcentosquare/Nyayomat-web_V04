    ...
    <div class="form-group">
      ...
      <div class="input-group code-field">
        ...
        <span class="input-group-btn">
          <button id="gc-pin-number" class="btn btn-lg btn-success generate-code" type="button"><i class="fa fa-rocket"></i> Generate</button>
        </span>
      </div>
      <div class="help-block with-errors"></div>
    </div>
  ...
  <div class="col-md-6 nopadding-left">
    <div class="form-group">
      ...
      <div class="input-group code-field">
        ...
        <span class="input-group-btn">
          <button id="gc-serial-number" class="btn btn-lg btn-success generate-code" type="button"><i class="fa fa-rocket"></i> Generate</button>
        </span>
      </div>
      <div class="help-block with-errors"></div>
    </div>
