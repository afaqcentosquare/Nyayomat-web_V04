                ...
                <div class="card p-4">
                    ...
                    <div class="card-body text-center">
                        ...
                        <a href="{{ route('homepage') }}"><img
                                src="{{ asset('acp/frontend/Images/Group 1000002714.png') }}" alt=""></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-4 pb-3">
                <div class="card p-4 ">
                    ...
                    <div class="card-body text-center">
                        ...
                        <a href="{{ route('boost.landing.page') }}"><img
                                src="{{ asset('acp/frontend/Images/Group 1000002714.png') }}" alt=""></a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="mail-card-mask p-5">
                        <div class="row">
                            <div class="col-lg-8">
                                ...
                                <form>
                                    <div class="sub-field d-flex">
                                        <input class="form-control me-2" placeholder="Email Address">
                                        <button class="btn btn-orange text-white text-wrap"
