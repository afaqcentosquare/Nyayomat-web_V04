<!--<link href="{{ URL::asset("public/css/fileinput.css") }}" rel="stylesheet">-->
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-fileinput/5.0.6/css/fileinput.min.css"/>

<!--<script src="{{ URL::asset("public/js/fileinput.js") }}"></script>-->
...
;(function($, window, document) {
	$( document ).ready(function () {
	    ...
	    var deleteTemplate = '<button type="button" class="kv-file-remove btn btn-kv btn-success btn-flat btn-xs" data-toggle="tooltip" data-placement="top" title="{{ trans('app.remove') }}" {dataUrl}{dataKey}><i class="fa fa-trash"></i></button>\n';

	    var downloadTemplate = '<a class="kv-file-download btn btn-success btn-flat btn-xs" data-toggle="tooltip" data-placement="top" title="{{ trans('app.download') }}" href="{downloadUrl}" download="" target="_blank"><i class="fa fa-download"></i></a>\n';

	    var zoomTemplate = '<button type="button" class="kv-file-zoom btn btn-success btn-flat btn-xs"  data-toggle="tooltip" data-placement="top" title="{{ trans('app.preview') }}"><i class="fa fa-search-plus"></i></button>';
