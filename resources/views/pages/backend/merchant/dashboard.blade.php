...
@section('content')
    ...
    <div class="row mt-3">
        <div class="col-12 mb-4">
            <a href="{{route('merchant.switchtoalternatvecreadit')}}" class="badge badge-pill shadow py-1 px-2 text-white" style="background-color:lightseagreen ">
                            ...
                            <div class="d-flex justify-content-between px-md-1">
                                <div>
                                    <h3 class="text-success display-5  d-none d-md-inline-flex">
                                        ...
                                        <small class="mr-2">Ksh</small> {{ round($sales_total ?? 0) }}
                                    </h3>
                                    {{-- Stubborn-Mobile --}}
                ...
                <div class="col-md-4 col-lg-3 mb-3 d-flex align-items-stretch">
                    <div class="card col-12 px-0 shadow-sm border-0">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between px-md-1">
                                <div>
                                    ...
                                    <h3 class="d-md-none d-sm-inline-flex mt-3 text-warning" style="font-size: 4.4vh">
                                        <span class="d-none">{{ $stock_out_count }}</span>
                                        {{number_format($stock_out_count,0)}}
                                    </h3>
                                    <p class="mb-0 mt-3 text-muted font-weight-light" >
                            ...
                            <div class="row mt-3">
                                <div class="col-12 text-right">
                                    <a href="{{route('merchant-stocks')}}" class="btn btn-sm btn-warning text-white" style="letter-spacing: .5px">
                ...
                <div class="col-md-4 col-lg-3 mb-3 d-flex align-items-stretch">
                    <div class="card col-12 px-0 shadow-sm border-0">
                        <div class="card-body">
                            ...
                            <div class="row mt-3">
                                <div class="col-12 text-right">
                                    <a href="{{route('merchant-disputs')}}" class="btn btn-sm btn-danger" style="letter-spacing: .5px">
                                        view <i class="bx bx-right-arrow-alt font-weight-bold" style="font-size: 12px"></i> 
                                    </a>
                                </div>
                            </div>
                ...
                <div class="col-md-4 col-lg-3    mb-3 d-flex align-items-stretch">
                    <div class="card col-12 px-0 shadow-sm border-0">
                        <div class="card-body">
                            ...
                            <div class="row mt-3">
                                <div class="col-12 text-right">
                                    <a href="{{route('actors')}}" class="btn btn-sm btn-info" style="letter-spacing: .5px">
                                        view <i class="bx bx-right-arrow-alt font-weight-bold" style="font-size: 12px"></i> 
                                    </a>
                                </div>
                            </div>
                                ...
                                <tr class="accordion" id="accordionExample2">
                                    ...
                                    <td nowrap>
                                        ...
                                        <span class="font-weight-light">
                                            <small class="">Ksh.</small>&nbsp;{{number_format(round(App\Inventory::where('title', $inventory->name)->value('sale_price')),2)}}
                                        </span>
                                    </td>
                                    ...
                                    <td nowrap>
                                        ...
                                        <span class="font-weight-light">
                                            <small class="">Ksh.</small>&nbsp;{{number_format(round(App\Inventory::where('title', $inventory->name)->value('sale_price') * $inventory->sold_qtt),2)}}
                                        </span>
                                    </td>
                                </tr>
                            @endforeach
            ...
            <div class="row">
                <div class="col-12 table-responsive">
                    <table class="table" id="myTable">
                        ...
                        <tbody>
                            @foreach($bottom_listings as $inventory)
                                <tr class="accordion" id="accordionExample2">
                                    ...
                                    <td nowrap>
                                        ...
                                        <span class="font-weight-light">
                                            <small class="">Ksh.</small>&nbsp;{{number_format(App\Inventory::where('title', $inventory->name)->value('sale_price'),2)}}
                                        </span>
                                    </td>
                ...
                {{-- <div class="col-md-3 mb-3 d-flex align-items-stretch">
                    <div class="card col-12 px-0 shadow-sm border-0">
                        <div class="card-body">
                            ...
                            <div class="row mt-3">
                                <div class="col-12 text-right">
                                    <a href="{{route('actors')}}" class="btn btn-sm btn-warning text-white" style="letter-spacing: .5px">
                                        view <i class="bx bx-right-arrow-alt font-weight-bold" style="font-size: 12px"></i> 
                                    </a>
                                </div>
                            </div>
                ...
                {{-- <div class="col-md-3 mb-3 d-flex align-items-stretch">
                    <div class="card col-12 px-0 shadow-sm border-0">
                        <div class="card-body">
                            ...
                            <div class="row mt-3">
                                <div class="col-12 text-right">
                                    <a href="{{route('actors')}}" class="btn btn-sm btn-danger" style="letter-spacing: .5px">
                                        view <i class="bx bx-right-arrow-alt font-weight-bold" style="font-size: 12px"></i> 
                                    </a>
                                </div>
                            </div>
