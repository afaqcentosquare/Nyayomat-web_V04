                ...
                <tbody class="accordion" id="groupDescription">
                    @for ($i = 0; $i < 10; $i++)
                        <tr>
                            ...
                            <td>
                                <a  data-toggle="collapse" href="#{{$descr = Str::random(8)}}" aria-expanded="false" aria-controls="{{$descr}}" class="mr-2 badge badge-pill">
                                ...
                                <a  data-toggle="collapse" href="#{{$prod = Str::random(8)}}" aria-expanded="false" aria-controls="{{$pres}}" class="mr-1 badge badge-pill">
                                    <i class="bx bx-plus-circle"  style="font-size: 14px"></i> Add Asset
                                </a>
                            </td>
                        </tr>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12 font-weight-bold">
                                                            <span class="text-info mr-4">
                                                                Total Asset Value : <small class="ml-2">Ksh</small> {{number_format(rand(50000,100000),2)}}
                                                            </span>
                                                        
                                                            <span class="text-success">
                                                                Total Engaged Asset Value : <small class="ml-2">Ksh</small> {{number_format(rand(50000,100000),2)}}
                                                            </span>
                                                        </div>
                                                    </div>
                                                </th>
