        ...
        <div class="col px-0 mx-auto shadow-sm rounded">
            <div class="accordion" id="groups">
                <div id="showgroups" class="collapse px-3 show" aria-labelledby="headingOne" data-parent="#groups"> 
                    ...
                    <div class="row">
                        <div class="col-12 text-right">
                            <a class="badge badge-pill badge-success py-2  mr-3 shadow rounded collapsed"  data-toggle="collapse" href="#newproduct" aria-expanded="false" aria-controls="newproduct">
                                NEW PRODUCT
                            </a>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4 mb-3 px-4">
                                                        <div class="row">
                                                            ...
                                                            <input type="text" class="col-12 py-2 bg-white shadow-sm rounded border-0" placeholder="Type" autocomplete="off" id="">
                                                        </div>
                                                    </div>                                
                                                    <div class="col-md-4 mb-3 px-4">
                                                        <div class="row">
                                                    ...
                                                    <div class="col-md-2 mb-3 px-4">
                                                        <h6 class="col-12 px-0" style="visibility: hidden">
                                                            Status
                                                        </h6>
                                                        <a href="" class="btn col-12 mx-0 py-2 btn-success btn-sm shadow-sm">
                ...
                <div class="card border-0">
                    ...
                    <div id="newproduct" class="collapse" aria-labelledby="headingTwo" data-parent="#groups">
                        <form action="" class="row">
