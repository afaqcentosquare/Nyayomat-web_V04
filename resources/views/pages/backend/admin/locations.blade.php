                ...
                <div class="card">
                    <div id="new_county" class="collapse" aria-labelledby="headingTwo" data-parent="#county_data">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{route('create.location')}}">
                                {{ csrf_field() }}
                                <div class="row">
                                    <div class="col-md-6 mb-3 px-4">
                                        <div class="row">
                                            ...
                                            <select name="region" class="col-12 bg-white shadow-sm rounded border-0 mx-auto" autocomplete="off" id="group">
                                    ...
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-success btn-sm shadow-sm">
                                            Add Location <i class="bx ml-1 bx-plus"></i>
                                        </button>
                                    </div>
                                </div>
                            </form>
