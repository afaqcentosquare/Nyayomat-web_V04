                                    ...
                                    @for ($i = 0; $i < 10; $i++)
                                        <tr>
                                            <td>
                                                ...
                                                SUB-GRP.{{$sb_grp = Str::random(8)}}
                                            </td>
                                            <td>
                                                {{Str::random(8)}}
                                            </td>
                                            <td>
                                                <a href="{{route('acp-category')}}" class="nyayomat-blue font-weight-bolder">
                                                    {{$c = rand(100,200)}}
                                                </a>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <a data-toggle="collapse" href="#{{$cat = Str::random(8)}}" class="btn btn-sm mr-3 shadow-sm font-weight-bold btn-outline-success">
                                                    Add Category
                                                </a>
                                                <a data-toggle="collapse" href="#{{$prod = Str::random(8)}}" class="btn btn-sm btn-outline-primary font-weight-bold shadow-sm">
                                                    Add Product
                                                </a>
                                            </td>
                                        </tr>
                                            ...
                                            <td colspan="5">
                                                <form action="" class="row">
                                                    ...
                                                    <div class="col-md-4 mb-4">
                                                        ...
                                                        <input type="text" disabled value="{{$sb_grp}}" autocomplete="off" class="col-12 py-2 rounded bg-transparent border-0">
                                                    </div>
                                                    <div class="col-md-4 mb-4">
                                                        <p class="text-muted col-12 px-0">
                                                            <b styl
