...
@section('content')
    ...
    <div class="row">
        <div class="col-12 mt-2 mb-3 font-weight-light">
            ...
            <a href="" class="text-muted mr-1">
                {{Illuminate\Support\Str::ucfirst("SUB-GRP-NME")}}
            </a> /
            <a href="" class="text-muted mr-1">
                {{Illuminate\Support\Str::ucfirst("CTG-NME")}}
            </a> /
            ...
            <div class="accordion" id="products">
                <div id="showproducts" class="collapse px-4 show" aria-labelledby="headingOne" data-parent="#products"> 
                    ...
                    <span class="">
                        ...
                        <span class="ml-1 font-weight-bold mr-2"> CATEGORY </span>  :
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 table-responsive">
                            <table class="table"  id="myTable">
                                ...
                                @foreach ( $categoryproducts as $productsincategory )
                                    
                                    @foreach ($productsincategory->products as $product )
                                        <tr>
                                            <td>
                                            {{$product->image->path?? 'No Image'}}
                                            </td>
                                            <td>
                                            {{$product->name}} 
                                            </td>
                                            <td>
                                            {{$product->image->name?? 'No Name'}}
                                            </td>
                                            <td>
                                                Owner
                                            </td>
                                        ...
                                        <tr id="{{$descr}}" class="collapse" aria-labelledby="headingOne" data-parent="#groupDescription">
                                            <td colspan="5">
                                                ...
                                                <a  data-toggle="collapse" href="#{{$trash = Illuminate\Support\Str::random(8)}}" aria-expanded="false" aria-controls="{{Illuminate\Support\Str::random(8)}}" class="mr-1 btn btn-sm shadow-sm btn-outline-danger">
                                                        <i class="bx bx-x mr-1" style="font-size: 14px"></i> No
                                                </a>
