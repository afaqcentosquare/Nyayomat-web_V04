@extends('layouts.backend.main', 
                        [
                            'title' => __("Edit-Faq-Topic"),
                            'page_name' => 'Edit-Faq-Topic',
        ...
        <div class="card rounded">
            <div id="newTopic">
                <div class="card-body">
                    ...
                    <form action="{{ route('update-faq-topic',['faq-topic-id'=>$faqtopic->id])  }}" method="POST" enctype="multipart/form-data" files="true" class="row">
                        @csrf
                        <div class="col-12 mb-4">
                            <p class="col-12 px-0">
                                Topic Title :
                            </p>
                            <input name="name" type="text" value="{{$faqtopic->name}}" autocomplete="off" class="col-12 py-2 rounded shadow-sm border-0">
                        </div>
                        <div class="col-12 mb-4">
                            <p class="col-12 px-0">
                                Target Group :
