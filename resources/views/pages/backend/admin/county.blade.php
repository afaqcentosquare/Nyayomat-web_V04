                        ...
                        <div class="col-12 table-responsive">
                            <table class="table display nowrap">
                                ...
                                <tbody class="accordion">
                                    ...
                                    @php
                                    $sub_county = App\Region::where('city', $city->id)->count();
                                    @endphp
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a   href="{{route('sub-county',$city->id)}}" class="mr-1 nyayomat-blue">
                ...
                <div class="card">
                    <div id="new_county" class="collapse" aria-labelledby="headingTwo" data-parent="#county_data">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{route('create.county')}}">
                                {{ csrf_field() }}
                                <div class="row">
                                    <div class="col-md-12 mb-3 px-4">
                                        <div class="row">
                                            ...
                                            <input type="text" name="county_name"
                                                ...
                                                placeholder="County Name" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-success btn-sm shadow-sm">
                                            Add County <i class="bx ml-1 bx-plus"></i>
                                        </button>
                                    </div>
                                </div>
                            </form>
