...
@push('link-css')
    ...
    <link href="{{asset('acp/css/graphs.css')}}" rel="stylesheet">
                        ...
                        <tbody class="accordion" id="approve_accordion">
                            @foreach ($approves as $key => $provider)                                                                                        
                                <tr>
                                        ...
                                        <ul class="list-unstyled">
                                            <li class="font-weight-normal">
                                                <a href="{{route('superadmin.redirect.assetprovider', $provider->id)}}" class="">
                                                    {{\Illuminate\Support\Str::title($provider->shop_name)}}
                                                </a>
                                            </li>
                                        </ul>
                                    </td>
                                    ...
                                    <td>
                                        <a class="text-decoration-none">
                                            {{\Illuminate\Support\Str::title($provider->county)}}
                                        </a>
                                    </td>
                                    <td>
                                        <a  class="text-decoration-none">
                                            {{\Illuminate\Support\Str::title($provider->sub_county)}}
                                        </a>
                                    </td>
                                    <td>
                                        <a class="text-decoration-none">
                                            {{\Illuminate\Support\Str::title($provider->location)}}
                                        </a>
                                    </td>
                                    <td nowrap>
                                ...
                                <tr id="approve_suspend{{$key}}" class="collapse" aria-labelledby="approve_suspend{{$key}}" data-parent="#approve_accordion">
                                    <td colspan="9">
                                        <p class="">
                                            You are about to suspend this <b>{{\Illuminate\Support\Str::title($provider->name)}}</b> account, proceed ?
                                        </p>
                ...
                <div class="col-12 table-responsive">
                    <table class="table">
                        <thead>
                            <tr>
                                <th>
                                    {{\Illuminate\Support\Str::title('applicant name')}}
                                </th>
                                <th>
                                    {{\Illuminate\Support\Str::title('shop name')}}
                                </th>
                                <th nowrap>
                                    {{\Illuminate\Support\Str::title('county')}}
                                </th>
                                <th nowrap>
                                    {{\Illuminate\Support\Str::title('sub county')}}
                                </th>
                                <th nowrap>
                                    {{\Illuminate\Support\Str::title('location')}}
                                </th>
                                <th nowrap>
                                    Contact
                                </th>
                                <th nowrap>
                                    {{\Illuminate\Support\Str::title('application date')}}
                        ...
                        <tbody class="accordion" id="application_accordion">
                            @foreach ($applications as $key => $applicant)
                                <tr>
                                    <td>
                                        {{\Illuminate\Support\Str::title($applicant->applicant_name)}}
                                    </td>
                                    <td>
                                        {{\Illuminate\Support\Str::title($applicant->shop_name)}}
                                    </td>
                                    <td>
                                        {{\Illuminate\Support\Str::title($applicant->county)}}
                                    </td>
                                    <td>
                                        {{\Illuminate\Support\Str::title($applicant->sub_county)}}
                                    </td>
                                    <td>
                                        {{\Illuminate\Support\Str::title($applicant->location)}}
                                    </td>
                                    <td nowrap>
                                    ...
                                    <td nowrap>
                                        {{$joined = Carbon\Carbon::parse($applicant->created_at, 'Africa/Nairobi')->format('d - M - Y @ h:i A')}}
                                    </td>
                                    <td nowrap>
                                ...
                                <tr id="approve{{$key}}" class="collapse" aria-labelledby="approve{{$key}}" data-parent="#application_accordion">
                                    <td colspan="9">
                                        <p class="">
                                            You are about to approve this <b>{{\Illuminate\Support\Str::title($applicant->shop_name)}}</b> application, proceed ?
                                        </p>
                                ...
                                <tr id="shortlist{{$key}}" class="collapse" aria-labelledby="shortlist{{$key}}" data-parent="#application_accordion">
                                        <td colspan="9">
                                            <p class="">
                                                You are about to shortlist this <b>{{\Illuminate\Support\Str::title($applicant->shop_name)}}</b> account, proceed ?
                                            </p>
                                ...
                                <tr id="decline{{$key}}" class="collapse" aria-labelledby="decline{{$key}}" data-parent="#application_accordion">
                                    <td colspan="9">
                                        <p class="">
                                            You are about to decline this <b>{{\Illuminate\Support\Str::title($applicant->shop_name)}}</b> application, proceed ?
                                        </p>
                    ...
                    <table class="table">
                        ...
                        <tbody class="accordion" id="accordion_shortlist">
                            @foreach ($shortlisted as $key => $shortlist)
                                <tr>
                                    <td>
                                        {{\Illuminate\Support\Str::title($shortlist->applicant_name)}}
                                    </td>
                                    <td>
                                        {{\Illuminate\Support\Str::title($shortlist->shop_name)}}
                                    </td>
                                    <td>
                                        {{\Illuminate\Support\Str::title($shortlist->county)}}
                                    </td>
                                    <td>
                                        {{\Illuminate\Support\Str::title($shortlist->sub_county)}}
                                    </td>
                                    <td>
                                        {{\Illuminate\Support\Str::title($shortlist->location)}}
                                    </td>
                                    <td nowrap>
                                    ...
                                    <td nowrap>
                                        {{$joined = Carbon\Carbon::parse($shortlist->created_at, 'Africa/Nairobi')->format('d - M - Y @ h:i A')}} ..
                                    </td>
                                    <td nowrap>
                                ...
                                <tr id="shortlist_approve{{$key}}" class="collapse" aria-labelledby="shortlist_approve{{$key}}" data-parent="#accordion_shortlist">
                                    <td colspan="9">
                                        {{-- <div class="row"> --}}
                                            <p class="">
                                                You are about to approve <b>{{\Illuminate\Support\Str::title($shortlist->shop_name)}}'s</b> application, proceed ?
                                            </p>
                                ...
                                <tr id="shortlist_decline{{$key}}" class="collapse" aria-labelledby="shortlist_decline{{$key}}" data-parent="#accordion_shortlist">
                                    <td colspan="9">
                                        <p class="">
                                            You are about to decline <b>{{\Illuminate\Support\Str::title($shortlist->shop_name)}}'s</b> application, proceed ?
                                        </p>
                            ...
                            @foreach ($suspended as $key => $suspend)
                                <tr>
                                    <td nowrap>
                                        <ul class="list-unstyled">
                                            <li class="font-weight-bold">
                                                {{\Illuminate\Support\Str::title($suspend->shop_name)}}
                                            </li>
                                        </ul>
                                    </td>
                                    <td>
                                ...
                                <tr id="suspend_reinstate{{$key}}" class="collapse" aria-labelledby="suspend_reinstate{{$key}}" data-parent="#suspend_accordion">
                                    <td colspan="9">
                                        <p class="">
                                            You are about to reinstate  <b>{{\Illuminate\Support\Str::title($suspend->shop_name)}}</b> as an active account, proceed ?
                                        </p>
