                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        {{\Illuminate\Support\Str::title('Units')}}
                                    </th>
                                    <th nowrap>
                                        {{\Illuminate\Support\Str::title('Unit Cost')}} 
                                        <span class="text-muted">
                                            (Ksh)
                                        </span>
                                    </th>
                                    <th nowrap>
                                        {{\Illuminate\Support\Str::title('P. Holiday')}} 
                                        <span class="text-muted">
                                            Days
                                        </span>
                                    </th>
                                    <th nowrap>
                                        {{\Illuminate\Support\Str::title('Deposit amount')}}<br>
                                        {{\Illuminate\Support\Str::title('(Per Unit)')}}
                                        <span class="text-muted">
                                            (Ksh)
                                        </span>
                                    </th>
                                    <th nowrap>
                                        {{\Illuminate\Support\Str::title('Installment Amount')}}<br>
                                        {{\Illuminate\Support\Str::title('(Per Unit)')}}
                                        <span class="text-muted">
                                            (Ksh)
                                        </span>
                                    ...
                                    <th nowrap>
                                        {{\Illuminate\Support\Str::title('P. Frequency')}}
        
                                    </th>
                                    <th nowrap>
                                        {{\Illuminate\Support\Str::title('P. Method')}}
                                    </th>
                                    <th nowrap>
                                        {{\Illuminate\Support\Str::title('P. Duration')}}
                                        <br>
                                        {{\Illuminate\Support\Str::title('(Per Unit)')}}
                                    </th>
                                    <th nowrap>
                                        {{\Illuminate\Support\Str::title('provider')}}
                                    </th>
                                    <th>
                            ...
                            <tbody>
                                @foreach ($prep_assets as $asset)
                                    <tr>
                                        <td nowrap>
                                            {{\Illuminate\Support\Str::title($asset->asset_name)}}
                                        </td>
                                        <td>
                                            {{$asset->units}}
                                        </td>
                                        ...
                                        <td>
                                            {{\Illuminate\Support\Str::title($asset->payment_frequency)}}
                                        </td>
                                        <td>
                                            {{\Illuminate\Support\Str::title($asset->payment_method)}}
                                        </td>
                                        <td>
                                            {{$asset->installment}}
                                        ...
                                        <td nowrap>
                                            {{-- {{\Illuminate\Support\Str::title($asset -> type_a -> provider -> name)}} --}}
                                            {{$asset->shop_name}}
                                        </td>
                                        <td nowrap>
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th nowrap>
                                    {{\Illuminate\Support\Str::title('P Duration')}}<br>
                                    {{\Illuminate\Support\Str::title('(Per Unit)')}}
            ...
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">
                        {{-- Edit <b>{{\Illuminate\Support\Str::title($asset -> type_a -> name)}}</b> from <b> {{\Illuminate\Support\Str::title($asset -> type_a -> provider -> name)}}</b> --}}
                    </h5>
                            ...
                            <select name="category_id" class="col-12 bg-white shadow-sm py-2 rounded border-0 mx-auto" autocomplete="off" id="">
                                @foreach (App\Category::get() as $category)
                                    <option value="{{$category -> id}}">
                                        ...
                                        |
                                        {{\Illuminate\Support\Str::title($category -> sub_group  -> name)}}
                                        |
                                        {{\Illuminate\Support\Str::title($category -> sub_group -> group -> name)}}
                                    </option>
                                @endforeach
                            </select>
                        </div>  --}}
