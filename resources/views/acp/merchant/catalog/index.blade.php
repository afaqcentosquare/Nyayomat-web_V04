                        ...
                        <table class="table" id="myTable">
                            <thead>
                                <tr>
                                    ...
                                    <th nowrap>
                                        {{\Illuminate\Support\Str::title('Unit Cost')}}<br>
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th nowrap>
                                    {{\Illuminate\Support\Str::title('Deposit amount')}}
                                </th>
                                <th nowrap>
                                    Installment Amount
                                </th>
    ...
    <div class="modal fade" id="remove{{$asset -> id }}"  data-keyboard="false"  data-backdrop="false" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">
                        {{-- Remove {{$asset -> type_a -> name}} from <b> {{\Illuminate\Support\Str::title($asset -> type_a -> provider -> name)}}</b> --}}
                    </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
    ...
    <div class="modal fade" id="merchant_request{{$asset->id }}"  data-keyboard="false"  data-backdrop="false" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">
                        {{\Illuminate\Support\Str::title($asset->asset_name)}} Request
                    </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
