        ...
        <div class="col-md-6 text-md-right">
            ...
            <ul class="col-12 list-unstyled">
                <li>
                    Engaged Assets : &nbsp;
                    @php
                      $total_engage_assets = App\Models\MerchantAssetOrder::where("asset_provider_id",$asset_provider_detail->id)->where('status', 'delivered')->groupBy("asset_id")->get();
            ...
            <div class="row mt-4">
                <div class="col-12 mb-4">
                    ...
                    <span class="font-weight-bold text-secondary mr-4">
                        Engaged Assets : {{!empty($products_engaged) ? count($products_engaged) : 0}}
                    </span>
                    {{-- <span class="font-weight-bold text-secondary mr-4">
                        Idle Assets : 0
                    </span>
                    ...
                    <table id="mytableID" class="table">
                        <thead>
                            <tr>
                                ...
                                <th nowrap class="">
                                    Holiday Period <br> <sub class="font-weight-normal">Day Count</sub>
                                </th>
                                <th nowrap class="">
                                    Unit Cost (Ksh)
                                </th>
                            ...
                            @endphp
                                <tr class="" style="">
                                    ...
                                    <td nowrap>
                                        ...
                                        {{$approve_asset->holiday_provision}} days
                                    </td>
                                    <td nowrap>
