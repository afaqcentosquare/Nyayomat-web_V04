                    ...
                    <tr>
                        ...
                        <td class="row-options">
                            <div class="btn-group">
                                ...
                                @endif
                                @can('view', $cart_list)
                                    <a href="#" data-link="{{ Route('admin.order.cart.show', $cart_list->id) }}" class="ajax-modal-btn btn btn-sm btn-success">
                                ...
                                @can('delete', $cart_list)
                                    {!! Form::open(['route' => ['admin.order.cart.trash', $cart_list->id], 'method' => 'delete', 'style' => 'display:inline;']) !!}
                                        <button type="submit" class="btn btn-sm btn-success confirm ajax-silent">
