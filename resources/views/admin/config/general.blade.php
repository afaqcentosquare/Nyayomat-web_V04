			        ...
			        <div class="col-sm-3">
						...
						<div class="text-center">
							...
							@if($shop->primaryAddress)
								...
								<a href="#" data-link="{{ route('address.edit', $shop->primaryAddress->id) }}"  class="btn btn-success ajax-modal-btn"><i class="fa fa-map-marker"></i> {{ trans('app.update_address') }}</a>
							@else
								<a href="#" data-link="{{ route('address.create', ['shop', $shop->id]) }}"  class="btn btn-success ajax-modal-btn"><i class="fa fa-plus-square-o"></i> {{ trans('app.add_address') }}</a>
							@endif
