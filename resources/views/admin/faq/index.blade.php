			    ...
			    <div class="box-header with-border">
					...
					<div class="box-tools pull-right">
						@can('create', App\Faq::class)
							<a href="#" data-link="{{ route('admin.utility.faqTopic.create') }}" class="ajax-modal-btn btn btn-success btn-flat">{{ trans('app.add_topic') }}</a>
						@endcan
					</div>
			    </div> <!-- /.box-header -->
			    <div class="box-body">
	  	...
	  	<div class="col-md-9">
			<div class="box">
			    <div class="box-header with-border">
			      ...
			      <div class="box-tools pull-right">
					@can('create', App\Faq::class)
						<a href="#" data-link="{{ route('admin.utility.faq.create') }}" class="ajax-modal-btn btn btn-success btn-flat">{{ trans('app.add_faq') }}</a>
					@endcan
			      </div>
			    </div> <!-- /.box-header -->
			    <div class="box-body">
