	    ...
	    <div class="box-header with-border">
	      ...
	      <div class="box-tools pull-right">
			@can('create', App\CategorySubGroup::class)
				<a href="#" data-link="{{ route('admin.catalog.categorySubGroup.create') }}" class="ajax-modal-btn btn btn-success btn-flat">{{ trans('app.add_category_sub_group') }} </a>
			@endcan
	      </div>
	    </div> <!-- /.box-header -->
	    <div class="box-body">
