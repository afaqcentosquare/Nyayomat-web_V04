    ...
    <div class="form-group">
      ...
      <div class="input-group code-field">
        ...
        <span class="input-group-btn">
          <button id="coupon" class="btn btn-lg btn-success generate-code" type="button" {{ isset($coupon) ? 'disabled' : '' }}><i class="fa fa-rocket"></i> Generate</button>
        </span>
      </div>
      <div class="help-block with-errors"></div>
    </div>
  ...
  <div class="col-md-6 nopadding-left">
    <div class="form-group">
      ...
      <div class="input-group">
        ...
        {!! Form::select('type', ['amount' => config('system_settings.currency_symbol') ?: 'KSh', 'percent' => trans('app.percent')], null, ['class' => 'selectpicker']) !!}
      </div>
      <div class="help-block with-errors"></div>
    </div>
  </div>
