<div class="box collapsed-box">
	<div class="box-header with-bcart">
		...
		<div class="box-tools pull-right">
			{{-- <a href="#" data-link="{{ route('admin.stock.inventory.bulk') }}" class="ajax-modal-btn btn btn-success btn-flat">{{ trans('app.bulk_import') }}</a> --}}
			<button type="button" class="btn btn-success btn-flat" data-widget="collapse"><i class="fa fa-plus"></i> {{ trans('app.add_inventory') }}</button>
		</div>
	</div> <!-- /.box-header -->
