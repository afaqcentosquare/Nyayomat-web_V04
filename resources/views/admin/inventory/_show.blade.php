				    ...
				    <div class="tab-pane active" id="listing_tab">
				        <table class="table">
							...
							<tr>
								...
								<td style="width: 75%;"> {{ round($inventory->sale_price) }} KSh</td>
							</tr>
				            ...
				            @if($inventory->puchase_price)
								<tr>
									...
									<td style="width: 75%;"> {{ round($inventory->puchase_price) }} KSh</td>
								</tr>
							@endif
				        ...
				        <table class="table">
				            ...
				            @if($inventory->product->min_price && $inventory->product->min_price > 0)
				                <tr>
				                	...
				                	<td style="width: 75%;">{{ round($inventory->product->min_price) }} KSh</td>
				                </tr>
				            @endif
				            @if($inventory->product->max_price && $inventory->product->max_price > 0)
				                <tr>
				                	<th class="text-right">{{ trans('app.max_price') }}: </th>
				                	<td style="width: 75%;">{{ round($inventory->product->max_price) }} KSh</td>
				                </tr>
				            @endif
				        ...
				        <table class="table">
				            @if($inventory->offer_price && $inventory->offer_price > 0)
								<tr>
									...
									<td style="width: 75%;">{{ round($inventory->offer_price) }} KSh</td>
								</tr>
					        @else
								<tr>
