	...
	<div class="box">
	    <div class="box-header with-border">
	      	...
	      	<div class="box-tools pull-right">
				<a href="#" data-link="{{ route('admin.account.ticket.reply', $ticket) }}" class="ajax-modal-btn btn btn-success btn-flat">{{ trans('app.reply') }}</a>
				<a href="{{ route('admin.account.ticket') }}" class="btn btn-success btn-flat">{{ trans('app.back') }}</a>
	      	</div>
	    </div> <!-- /.box-header -->
	    <div class="box-body">
			<div class="row">
			  	...
			  	<div class="col-md-7">
					...
					@if(count($ticket->attachments))
						...
						@foreach($ticket->attachments as $attachment)
				            <a href="{{ route('attachment.download', $attachment->id) }}"><i class="fa fa-file"></i></a>
						@endforeach
					@endif
