...
return [
    ...
    */
    ...
    'email_verification_notice' => 'Your email address is not verified. Please verify to get full access! If you haven\'t received the verification email, you can resend again from your profile page.',
