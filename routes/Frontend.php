...
Route::group(['middleware' => ['storefront'], 'namespace' => 'Storefront'], function () {
    ...
    Route::get('/ecommerce', 'HomeController@index')->name('homepage');
    Route::post('categories', 'HomeController@country')->name('countrywise');
...
/*Category Routes */
// Route::get('categories/{location?}', 'EcommerceFrontend\CategoryController@categories')->name('categories');
// Route::get('category/{slug}', 'EcommerceFrontend\ProductController@products')->name('category.products');
