				...
				<table class="table" id="buyer-payment-detail-table">
					...
					<tbody>
						...
						<tr class="buyer-payment-info-body">
							<td>{{ round($order->total) }} KSh</td>
							<td>{{ round($order->shipping + $order->handling) }} KSh</td>
							<td>{{ round($order->packaging) }} KSh</td>
							<td>{{ round($order->taxes) }} KSh</td>
							<td>{{ round($order->discount) }} KSh</td>
                        ...
                        <tr class="buyer-payment-info-body">
							<td colspan="2">{{ round($order->grand_total) }} KSh</td>
							<td colspan="2">{{ $pmn }}</td>
