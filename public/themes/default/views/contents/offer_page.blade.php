            ...
            @foreach($product->inventories->sortBy(function($item){
                ...
                <tr class="sc-product-item">
                    ...
                    <td class="seller-info">
                        ...
                        <span class="small">
                            @include('layouts.ratings', ['ratings' => $offer->shop->feedbacks->avg('rating'), 'count' => $offer->shop->feedbacks->count()])
                        </span>
                    </td>
                    <td>
                        <a class="btn btn-success flat btn-block btn-sm itemQuickView" href="{{ route('quickView.product', $offer->slug) }}">
                        ...
                        <a class="btn btn-success flat btn-block sc-add-to-cart" href="{{ route('cart.addItem', $offer->slug) }}">
