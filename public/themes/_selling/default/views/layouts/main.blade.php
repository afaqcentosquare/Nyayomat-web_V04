        ...
        <header>
            <div class="container">
                <div class="intro-text">
                    <div class="intro-lead-in" style="font-weight: bold;">{{ __('theme.intro_lead') }}</div>
                    <div class="intro-heading">{{ __('theme.intro_heading') }}</div>
                    <a href="{{ route('register') }}" class="btn btn-success btn-lg selling">{{ __('theme.button.selling') }}</a>
                    {{-- <p class="sellin-price-tagline">{{ __('theme.selling_price_taglind', ['price' => round($subscription_plans->min('cost')) .' KSh' ]) }}</p> --}}
                    <p class="sellin-price-tagline">Enjoy 1-month FREE trial. No commitments, cancel anytime.</p>
                    <p class="sellin-price-tagline">
                        Pricing: After 1 month free trial period, Start selling at KSh 20 per day*
                        </br>
                        *Rate for each location merchant serves
                    </p>
                </div>
            </div>
        </header>
