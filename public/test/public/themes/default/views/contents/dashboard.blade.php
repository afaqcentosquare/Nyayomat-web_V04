...
<div class="row">
    ...
    <div class="col-sm-4 col-xs-6 ">
      <div class="info-box bg-gray">
        ...
        <div class="info-box-content">
          {{-- <a href="{{ route('account', 'pendingreviews') }}" class="info-box-text">Reviews</a> --}}
          <a href="{{ route('account', 'pendingreviews') }}" class="info-box-text">Pending Reviews</a>
          <span class="info-box-number">{{ $dashboard->orders()->whereNull('feedback_id')->count() }}</span>
        </div>
        <!-- /.info-box-content -->
      </div>
      <!-- /.info-box -->
