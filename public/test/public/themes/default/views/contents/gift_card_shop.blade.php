        ...
        <div class="col-md-3">
            <div class="product product-grid-view sc-product-item">
                ...
                <div class="product-actions btn-group">
                    <a class="btn btn-success flat" href="{{ route('wishlist.add', $item) }}">
                    ...
                    <a class="btn btn-success flat itemQuickView" href="{{ route('quickView.product', $item->slug) }}">
                    ...
                    <a class="btn btn-success flat sc-add-to-cart" href="#">
...
<div class="row pagenav-wrapper">
  {{ $giftCards->links('layouts.pagination') }}
