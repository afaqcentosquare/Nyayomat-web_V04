        ...
        @if ($carts->count() > 0)
                            ...
                            <tbody>
                                @foreach ($cart->inventories as $item)
                                    ...
                                    <tr class="cart-item-tr">
                                        ...
                                        <td>
                                            <a class="cart-item-remove" href="javascript:void(0)"
                                                data-cart="{{ $cart->id }}" data-item="{{ $item->id }}"
                                ...
                                <li>
                                    <span>
                                        <a class="dynamic-shipping-rates" data-toggle="popover"
                                            data-cart="{{ $cart->id }}" data-options="{{ $shipping_options }}"
            ...
            <div style="display: flex;">
                ...
                <form method="post" action="{{ route('cart.checkout_all') }}" style="margin-left:5px">
                    @csrf
                    <button type="submit"
                        class="btn btn-success flat nyayom-btn">{{ trans('theme.button.checkout_all') }}</button>
                </form>
            </div>
        @else
