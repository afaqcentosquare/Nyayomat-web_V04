  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-8">
                  ...
                  <tr class="order-body">
                    <td colspan="3">
                      ...
                      <div class="text-center space20">
                        @if(optional($order)->dispute->isClosed() )
        ...
        @else
          <p class="text-center">
              <a href="{{ route('order.detail', $order) . '#message-section' }}" class="btn btn-success flat">{!! trans('theme.button.contact_seller') !!}</a>

              @unless($order->dispute)
                <a href="#" data-toggle="modal" data-target="#disputeOpenModal" class="btn btn-success flat">{!! trans('theme.button.open_dispute') !!}</a>
              @endunless
          </p>
          <div class="sep"></div>
          <p class="text-muted">
