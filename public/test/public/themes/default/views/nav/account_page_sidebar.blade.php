...
<ul class="account-sidebar-nav">
    <li class="{{ $tab == 'dashboard' ? 'active' : '' }}">
    	<a href="{{ route('account', 'dashboard') }}"><i class="fa fa-dashboard"></i> Overview</a>
    </li>
    <li class="{{ $tab == 'orders' ? 'active' : '' }}">
    	<a href="{{ route('account','orders') }}"><i class="fa fa-shopping-cart"></i> @lang('theme.nav.my_orders')</a>
    </li>
    <li class="{{ $tab == 'pendingreviews' ? 'active' : '' }}">
    	<a href="{{ route('account', 'pendingreviews') }}"><i class="fa fa-warning"></i> Pending Reviews</a>
    </li>
